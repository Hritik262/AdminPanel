...
import { createUser, getUsers, getUserById, updateUserById, deleteUser, restoreUser, permanentDeleteUser, assignRole, revokeRole } from '../controllers/userController.js';
...
router.put('/:id', adminMiddleware, validateUpdateUser, updateUserById);
